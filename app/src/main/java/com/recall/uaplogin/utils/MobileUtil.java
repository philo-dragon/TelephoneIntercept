        ...
        if (phoneNo.startsWith("+86")) {
            ...
            if (phoneNo.startsWith("+861")
                ...
                if (!phoneNo.startsWith("+8610")) {
                    ...
                    if (areaCodes.contains(areaCode.substring(3, 5))) {
                ...
                if (areaCodes.contains(areaCode.substring(3, 6))) {
                    return phoneNo.substring(6);//如果匹配不到则去掉首位0即可。
                } else {
                    return phoneNo;
                }
            }
            ...
            if (phoneNo.startsWith("01")
                ...
                if (!phoneNo.startsWith("010")) {
                    ...
                    if (areaCodes.contains(areaCode.substring(1, 3))) {
                ...
                if (areaCodes.contains(areaCode.substring(1, 4))) {
